...
main():
    ...
    check_file(file_name='notMNIST_train.zip', checksum='c8673b3f28f489e9cdf3a3d74e2ac8fa')
    check_file(file_name='notMNIST_train.zip', checksum='5d3c7e653e63471c88df796156a9dfa9')
